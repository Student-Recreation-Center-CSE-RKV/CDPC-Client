...
function Navbar() {
  ...
  const Scrollbar = React.forwardRef(({ style, children }, ref) => {
    return (
        <div ref={ref} style={style} className="scrollbar">
  ...
  return <div>
     {/* <Scrollbar ref={scrollbarRef} style={{ width: 250, height: 250 }}> */}
      <AppBar className='navbar' position="fixed" sx={{ margin:"0px", backgroundColor: 'rgb(9, 44, 95)',zIndex:'1000'}}>
